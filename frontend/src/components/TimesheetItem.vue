...
const statusMap = {
	...
	Submitted: "blue",
	Cancelled: "red",
	"Pending Project Approval": "orange",
...
const status = computed(() => {
	if (props.doc.custom_is_weekly) return props.doc.custom_weekly_status || "Draft"
...
const dateRange = computed(() => {
	...
	return `${dayjs(props.doc.start_date).format("D MMM")} – ${dayjs(props.doc.end_date).format(
		"D MMM YYYY"
	)}`
})
</script>
